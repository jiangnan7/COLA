...
def sample_dir(top: str, bench: str) -> str:
    # e.g. "relu" + "32x32" -> /.../sample/relu32x32
...
for idx in range(len(bench_list)):
    ...
    res_root     = sample_dir(top_list[0], bench_list[idx])                  # /home/edalab/EDA-DSE/sample/relu32x32
    ...
    for seed in seeds:
        ...
        path    = f'../dataset/relu_num/{bench_list[idx]}_dataset_num.csv'
        ...
        os.system(f"cd /home/edalab/EDA-DSE/sample && python3 /home/edalab/EDA-DSE/sample/clean_bambu_results.py")
